...
public class LogicalOperators {
	...
	public static void main(String[] args) {
	 ...
	 /*
	  * && : and logic   true &&true ==>, if both conditions are true,will return true
	  * other wise it gives you false
	  * 
 	  * || : or logic true || false ==> true
 	  * 			  true || true ==> true
 	  * 			  false || false ==> false
 	  * 			if both conditions are false it will return false, 
 	  * other wise will return true		
	  * 
	  * 
	  */
	
	boolean ResultA = 9 ==0 && "Mauhtar" == "good";
	//				false 		false ==> false
