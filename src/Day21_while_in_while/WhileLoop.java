...
public class WhileLoop {
	public static void main(String[] args) {
		...
		/*
		 while loop: for (initialization;condition;iterator)
		 but for while loop ( condition) {
		 						statements
		 						}
		 						loop gets executed as long as 
		 						the condtion is true
		 						
		 						a repeating if statement
		 						compiler first chaecks the condition
		 						of the while loop, if its true executes
		 						the loop , other wise stops executing
		 						
		 							any for loop can always be
